...
class AI(Player):
    def ask(self):
        ...
        y = str(d.y)
        y = y.replace('0', 'a').replace('1', 'b') \
            .replace('2', 'c').replace('3', 'd') \
            .replace('4', 'e').replace('5', 'f') \
            .replace('6', 'g').replace('7', 'i') \
            .replace('8', 'k')
        print(f"Ход компьютера: {d.x + 1} {y}")
        return d
class User(Player):
    def ask(self):
        while True:
            ...
            if len(cords) != 2:
                ...
                continue
            x, y = cords
            y = y.replace('a', '1').replace('b', '2') \
            .replace('c', '3').replace('d', '4') \
            .replace('e', '5').replace('f', '6') \
            .replace('g', '7').replace('i', '8') \
            .replace('k', '9')
